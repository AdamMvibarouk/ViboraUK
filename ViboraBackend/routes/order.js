 ...
 * Uses:
 *  - orders:      order_id, user_id, order_number, status, subtotal, discount_total,
 *                 tax_total, shipping_total, grand_total, placed_at
 *  - order_items: order_item_id, order_id, variant_id, quantity, unit_price, line_total
 */
router.get("/", verifyToken, async (req, res) => {
  try {
    const userId = req.user.id; // this is users.user_id from the JWT
