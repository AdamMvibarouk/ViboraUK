document.addEventListener("DOMContentLoaded", () => {
  ...
  // Sportswear category ID
  const SPORTSWEAR_CATEGORY_ID = "e6660501-cf7e-11f0-a24b-005056b707be";
  ...
  // load ONLY sportswear products from backend
  function loadProducts() {
    fetch(`http://localhost:5000/api/products?category_id=${SPORTSWEAR_CATEGORY_ID}`)
      .then((res) => res.json())
  ...
  // search within sportswear products
